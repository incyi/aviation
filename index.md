...
## 📘 LAPL-TMG Pilot logbook

| Date       | From | To   | Aircraft Type         | Registration | Crew Function | Flight Time | Operation Type     | Remarks                 |
|------------|------|------|-----------------------|--------------|---------------|-------------|--------------------|-------------------------|
|2026-00-00  |EHHV  |EHxx  |Super Dimona           |PH-0000       |Dual           | 1.0         |Introductory flight | (Future insallah)       |
...
<script src="{{ '/assets/js/magic.js' | relative_url }}"></script>
